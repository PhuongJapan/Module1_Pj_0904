...
function displayDataToEdit(courseId) {
  ...
  action = "Edit";
  // document.getElementById("editCourseModal").style.display="block !important"
...
document.getElementById("btnSearchCourseName").addEventListener("click",function (event) {
  event.preventDefault();
